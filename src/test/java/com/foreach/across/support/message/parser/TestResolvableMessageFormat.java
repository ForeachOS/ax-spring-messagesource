...
import com.foreach.across.support.message.MessageResolver;
import com.foreach.across.support.message.ResolvableMessage;
import com.foreach.across.support.message.ResolvableMessageFormat;
...
import static com.foreach.across.support.message.ResolvableMessageFormatContext.builder;
...
{
	private MessageResolver messageResolver = mock( MessageResolver.class );
